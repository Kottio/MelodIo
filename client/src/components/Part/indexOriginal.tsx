...
function Part() {
  ...
  function printMelody(melodyNote: string, index) {
    return <li key={index} className="flex flex-col justify-center items-center gap-2" >
      <div className="bg-white-200 p-5 rounded flex justify-center items-center w-20 h-20">
  ...
  return <>
    <div className="bg-white w-screen h-screen flex justify-center items-center"   >
      ...
      <section className="bg-[#101010] w-7/8 h-7/8 rounded flex flex-col  items-center">
        {/* <div className=" w-full flex flex-col items-center"> */}
        <div className="w-full pt-3 flex justify-center items-center gap-3">

          {/* <Link to={`/composition/${compositionId}`} className="group border-white border-1"  >
          ...
          <div className="flex justify-end items-end w-4/6 pt-5 border-b-neutral-200 border-b-1 pb-2"></div>
        ...
        <div className=" w-8/9 border-l-1 mt-3 flex flex-col justify-start items-center">


          <div className="flex justify-between  w-full  pb-2">
            <div className="flex items-center pb w-full  justify-baseline  gap-2 ">
